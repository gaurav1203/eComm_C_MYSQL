        ...
        while(1)
        {
            ...
            if(((strcmp(buff,"Refrigerator"))&&(strcmp(buff,"Laptop"))&&(strcmp(buff,"Camera"))&&(strcmp(buff,"Phone")))&&(index > 1))
            {
                while(atoi(row[3]) < atoi(user_count))
                {
                    printf("\e[1;1H\e[2J");
                    printf("\n\n\n\n");
                    printf("%sOnly %s pieces are available for the chosen item, you've entered %s, kindly re-enter the count\n\n\n\n",space,row[3],user_count);
                    take_user_count(user_count,sizeof(user_count));
                }
            ...
            if((!strcmp(buff,"Phone"))&&(index > 1))
            {
                while(atoi(row[9]) < atoi(user_count))
                {
                    printf("\e[1;1H\e[2J");
                    printf("\n\n\n\n");
                    printf("%sOnly %s pieces are available for the chosen item, you've entered %s, kindly re-enter the count: ",space,row[9],user_count);
                    take_user_count(user_count,sizeof(user_count));
                }
